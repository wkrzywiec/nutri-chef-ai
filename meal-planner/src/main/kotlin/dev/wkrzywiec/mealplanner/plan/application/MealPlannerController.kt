...
class MealPlannerController(
    ...
    fun proposeMealStream(
        ...
        //domenowy wrapper na SseEmitera, informujący o każdym evencie
        // a najlepiej intrerfejs na emitter eventów, tak, żeby używać sseEmitera, albo czegoś innego w przyszłości (streamresponsebody?)
        // czyli byłby domenowy emiter -> interfejs portu emitera -> konkretny emiter z sseemiterem, streamingresponsebody, zwykły http
        // https://medium.com/@AlexanderObregon/how-to-implement-server-sent-events-sse-in-spring-boot-620024272ccb


        // These headers help when running behind proxies (nginx) that buffer responses.
